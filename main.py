...
if __name__ == '__main__':
      ...
      parser = argparse.ArgumentParser(description="Script solving the best shares to buy for a specific wallet")
      parser.add_argument("filename", type=str, help="Path to the CSV file")
      parser.add_argument("--wallet", type=int, help="Choose the wallet size in euro", default=500)
      parser.add_argument("--algorithm_type", type=str, choices=["brute", "optimized"], help="Solving method"
                                                                                           "Default = Brute-force",
                          default="brute")
